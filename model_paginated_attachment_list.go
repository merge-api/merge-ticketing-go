...
// PaginatedAttachmentList struct for PaginatedAttachmentList
...
func (o *PaginatedAttachmentList) SetNextNil() {
	o.Next.Set(nil)
}
...
func (o *PaginatedAttachmentList) SetPreviousNil() {
	o.Previous.Set(nil)
}
...
func (o PaginatedAttachmentList) MarshalJSON() ([]byte, error) {
...
func (v *PaginatedAttachmentList) UnmarshalJSON(src []byte) error {
    type PaginatedAttachmentListUnmarshalTarget PaginatedAttachmentList

	var intermediateResult PaginatedAttachmentListUnmarshalTarget
	...
	*v = PaginatedAttachmentList(intermediateResult)
	return nil
}
type NullablePaginatedAttachmentList struct {
	value *PaginatedAttachmentList
	isSet bool
}

func (v NullablePaginatedAttachmentList) Get() *PaginatedAttachmentList {
	return v.value
}

func (v *NullablePaginatedAttachmentList) Set(val *PaginatedAttachmentList) {
	v.value = val
	v.isSet = true
}

func (v NullablePaginatedAttachmentList) IsSet() bool {
	return v.isSet
}

func (v *NullablePaginatedAttachmentList) Unset() {
	v.value = nil
	v.isSet = false
}

func NewNullablePaginatedAttachmentList(val *PaginatedAttachmentList) *NullablePaginatedAttachmentList {
	return &NullablePaginatedAttachmentList{value: val, isSet: true}
}

func (v NullablePaginatedAttachmentList) MarshalJSON() ([]byte, error) {
	return json.Marshal(v.value)
}

func (v *NullablePaginatedAttachmentList) UnmarshalJSON(src []byte) error {
	v.isSet = true

...
// TicketingAttachmentResponse struct for TicketingAttachmentResponse
...
func NewTicketingAttachmentResponse(model Attachment, warnings []WarningValidationProblem, errors []ErrorValidationProblem) *TicketingAttachmentResponse {
	this := TicketingAttachmentResponse{}
	this.Model = model
...
func (o TicketingAttachmentResponse) MarshalJSON() ([]byte, error) {
...
func (v *TicketingAttachmentResponse) UnmarshalJSON(src []byte) error {
    type TicketingAttachmentResponseUnmarshalTarget TicketingAttachmentResponse

	var intermediateResult TicketingAttachmentResponseUnmarshalTarget
	...
	*v = TicketingAttachmentResponse(intermediateResult)
	return nil
}
type NullableTicketingAttachmentResponse struct {
	value *TicketingAttachmentResponse
	isSet bool
}

func (v NullableTicketingAttachmentResponse) Get() *TicketingAttachmentResponse {
	return v.value
}

func (v *NullableTicketingAttachmentResponse) Set(val *TicketingAttachmentResponse) {
	v.value = val
	v.isSet = true
}

func (v NullableTicketingAttachmentResponse) IsSet() bool {
	return v.isSet
}

func (v *NullableTicketingAttachmentResponse) Unset() {
	v.value = nil
	v.isSet = false
}

func NewNullableTicketingAttachmentResponse(val *TicketingAttachmentResponse) *NullableTicketingAttachmentResponse {
	return &NullableTicketingAttachmentResponse{value: val, isSet: true}
}

func (v NullableTicketingAttachmentResponse) MarshalJSON() ([]byte, error) {
	return json.Marshal(v.value)
}

func (v *NullableTicketingAttachmentResponse) UnmarshalJSON(src []byte) error {
	v.isSet = true

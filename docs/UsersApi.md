...
func main() {
    ...
    emailAddress := "emailAddress_example" // string | If provided, will only return users with emails equal to this value (case insensitive). (optional)
